...
object NinegagString {
    ...
    fun commentSnackbarPinNoLongerAvailable(): StringDesc = StringDesc.Resource(MR.strings.comment_snackbar_pin_no_long_available)
    fun commentSnackbarCommentNoLongerAvailable(): StringDesc = StringDesc.Resource(MR.strings.comment_snackbar_comment_no_long_available)
    fun commentTooltipsPinnedComment(): StringDesc = StringDesc.Resource(MR.strings.comment_tooltip_pinned_comment)
    ...
    fun notifDialogPostPushRepromptTitle(): StringDesc = StringDesc.Resource(MR.strings.notif_dialog_postpushreprompt_title)
    fun notifDialogPostPushRepromptDesc(): StringDesc = StringDesc.Resource(MR.strings.notif_dialog_postpushreprompt_desc)
    fun notifDialogPostPushRepromptConfirmBtn(): StringDesc = StringDesc.Resource(MR.strings.notif_dialog_postpushrepromptconfirm_btn)
    fun notifDialogPostPushRepromptCancelBtn(): StringDesc = StringDesc.Resource(MR.strings.notif_dialog_postpushrepromptcancel_btn)
    fun notifSettingPostPushRepromptTitle(): StringDesc = StringDesc.Resource(MR.strings.notif_setting_postpushreprompt_title)
    fun notifSettingPostPushRepromptBtn(): StringDesc = StringDesc.Resource(MR.strings.notif_setting_postpushreprompt_btn)
